        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex items-center ml-auto mr-4">
                <form action="{{ route('search.index') }}" method="GET" class="relative group">
                    <input type="text" name="query" placeholder="Search..." class="bg-gray-800/80 border border-gray-700/50 text-sm rounded-full text-white focus:ring-indigo-500 focus:border-indigo-500 block w-48 focus:w-64 transition-all duration-300 pl-10 p-2 shadow-inner">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-400 group-focus-within:text-indigo-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    </div>
                </form>
            </div>
